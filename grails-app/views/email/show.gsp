...
<html>
    ...
    <body>
        ...
        <div id="show-email" class="content scaffold-show" role="main">
            ...
            <f:display bean="email" />
            <g:form resource="${this.email}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.email}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
